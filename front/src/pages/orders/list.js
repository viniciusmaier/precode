...
class OrdersListScreen extends HTMLElement {
    orderApi = new OrdersServicesApi();
    ...
    async connectedCallback() {
        ...
        this.addEventListener("updateListOrders", async () => {
        ...
        this.addEventListener("detailsOrderModal", async (obj) => {
            const data = await this.orderApi.getById(obj.detail.orderId);
            this.openModal(data);
        });
    ...
    async loadData() {
        ...
        const data = await this.orderApi.listAll(filterValues);
